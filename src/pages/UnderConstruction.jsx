...
export default function UnderConstruction() {
  return (
    <section className="relative z-1 overflow-hidden max-lg:pt-150 max-sm:pt-100">
      <Seo title="Under Construction" />
      <div className="container-lg">
        <div className="row items-center justify-center lg:h-screen lg:min-h-800 h-auto">
          <div className="lg:w-1/2 w-full max-sm:mb-10">
            <div className="lg:max-w-600">
              <div className="pb-60">
                <Link href="/home">
              ...
              <h2 className="xl:text-7xxl/85 md:text-5xl/50 text-4xl font-semibold xl:mb-30 mb-15">Our website is <span>under construction</span></h2>
          ...
          <div className="lg:w-1/2 w-full">
            <div className="lg:w-[50vw]">
              <Image loading="lazy" className="w-full" src={IMAGES.underconstruction} alt="img" />
            </div>
          </div>
          <div className="text-center w-full mx-auto !mt-auto  py-15">
            <div className="flex justify-center sm:items-center max-sm:flex-col-reverse">
